...
const canvasEl = document.querySelector("#flower");
...
window.addEventListener("resize", updateSize);
    ...
    function handleClickOrTouch(e) {
        ...
        // toggleEl.innerHTML = isRendering ? "じかんをとめる" : "じかんをうごかす";
    }
    var flower = document.getElementById('flower');

    flower.addEventListener("click", handleClickOrTouch);
    flower.addEventListener("touchstart", handleClickOrTouch);
